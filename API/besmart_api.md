...
<h1 id="besmart-rest-api">besmart REST API v0.45.32.1</h1>
...
```http
GET /api/sensors/{client_cid}.{sensor_mid}/signals/{signal_type_moid}/data?since=1726433785000&till=1726520185000 HTTP/1.1
...
r = requests.get('/api/sensors/{client_cid}.{sensor_mid}/signals/{signal_type_moid}/data', params={
  'since': '1726433785000',  'till': '1726520185000'
}, headers = headers)
