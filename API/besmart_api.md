...
<h1 id="besmart-rest-api">besmart REST API v0.45.32.6</h1>
...
```http
GET /api/sensors/{client_cid}.{sensor_mid}/signals/{signal_type_moid}/data?since=1726668911000&till=1726755311000 HTTP/1.1
...
r = requests.get('/api/sensors/{client_cid}.{sensor_mid}/signals/{signal_type_moid}/data', params={
  'since': '1726668911000',  'till': '1726755311000'
}, headers = headers)
